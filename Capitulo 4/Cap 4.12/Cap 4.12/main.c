...
if (N1 < N2)
    ...
    I = N2 / 2;
 /* Se inicializa con el maximo valor posible que puede ser divisor de N1 y N2. */
while ((N1 % I) || (N2 % I))
/* El ciclo se mantiene activo mientras (N1 % I) o (N2 % I) sean distintos de cero. Cuando el resultado sea 0, el ciclo se detiene ya que se habra encontrado el maximo comun divisor. */
I--;
return I;
}
