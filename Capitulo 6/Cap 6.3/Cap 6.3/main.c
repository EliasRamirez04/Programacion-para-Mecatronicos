...
/* Universidad.
El programa, al recibir información sobre el número de alumnos que han ingresado a sus ocho diferentes carreras
en los dos semestres lectivos de los últimos cinco años, obtiene información útil para el departamento de escolar. */
...
/* Esta función se utiliza para determinar la carrera que recibió el mayor número de alumnos el último año.
...
void Funcion3(int A[][C][P], int CO, int PR)
