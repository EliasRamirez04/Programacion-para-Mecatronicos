...
do
{
    print("Ingrese el numero de filas de los arreglos: ");
    scanf("%d", &FIL);
}
while (FIL> MAX || FIL< 1);
...
en un tercer arreglado bidimensional. */
{
int I, J;
for (I=0; I<F; I++)
    for (J=0; J<C; J++)
...
/* La funcion Imprime se utiliza para escribir un arreglo bidimensional de tipo entero
